...
@section('title', 'Drupal Development')
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="breadcrumb__content">
                    <h2 class="title">Drupal Development</h2>
            ...
            <div class="col-lg-6">
                <div class="about__content-seven">
                    <div class="section-title mb-25">
                        <span class="sub-title">Our Drupal Service</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="services__item-two">
                    ...
                    <div class="services__content-two">
                        <h2 class="title"><a href='/services-details'>Maseno University</a></h2>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="services__item-two">
                    ...
                    <div class="services__content-two">
                        <h2 class="title"><a href='/services-details'>AACC</a></h2>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="services__item-two">
                    ...
                    <div class="services__content-two">
                        <h2 class="title"><a href='/services-details'>Tom Mboya University</a></h2>
                    </div>
                </div>
            </div>
